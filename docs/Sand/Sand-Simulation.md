...
(2 px, 184 x 224), MEDIUM (3 px, 122 x 149, the default), LOW (4 px,
92 x 112) or VERY LOW (6 px, 61 x 74) - so the grid's own byte budget varies
with it, from 41 KB down to about 4.5 KB; two bytes per cell at the finest
setting would be 82 KB, against roughly 90 KB actually free once the
