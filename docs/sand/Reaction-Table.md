...
- If anything wet touches it, it *melts* **slowly**, turning into $\textcolor{#1863A3}{\text{water}}$. Soaked ground counts, more slowly the drier it is.
- Once it has *settled*, it slowly crusts into $\textcolor{#16A0CC}{\text{ice}}$ (35 in 1024 a step, and only while at rest).
...
- It *soaks up* any $\textcolor{#1863A3}{\text{water}}$ it touches **slowly**, and gets wetter.
- It *dries out* **slowly**, all by itself.
...
| Acid | Gunpowder | nothing (seldom smoke) | — / handily | both rolls must pass |
| Acid | Water | Gas, or swaps identity with Water | — / handily | one roll: 20/256 Acid alone boils to Gas; else 118/256 baseline Acid->Water & Water->Steam, or 118/256 baseline Acid->Gas & Water->Acid - shifted by local backing (sand_set_acid_dilute_mass_bias()) |
| Acid | Oil | Oil becomes Gas or Acid; Acid may die too | — / poorly | two independent rolls: 220/256 Oil becomes Gas (else Acid); separately 128/256 the Acid cell dies outright (else it survives and pays a quench cost) |
| Gas | Fire / Lava | Fire | instantly |  |
| Wood | Fire / Lava | Wood, alight | — |  |
| Oil | Fire / Lava | Fire | — | only where it touches air |
| Plant | Fire / Lava | Fire | — |  |
| Leaf | Fire / Lava | Fire | — |  |
| Gunpowder | Fire / Lava | Lit Gunpowder | — |  |
...
| Gunpowder | Fire / Lava | Lit Gunpowder | — | or through a conductor |
...
| Gunpowder | Water / Acid | itself, soaked | on contact | quench_to is not read on this path |
...
| Water | Gunpowder | Gunpowder, +1 moisture | slowly | no material change - soaks_to is 0 |
...
| Gunpowder | (none - self-driven) | Gunpowder, -1 moisture | slowly |  |
...
specific: any material with a moisture codec (`dries != 0`) pays the same
curve.

**Burning out checks for a lit 2x2, with an impulse-buffer fallback to
