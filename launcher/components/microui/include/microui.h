 ...
 *
 * These sizes are baked into mu_Context as fixed arrays, and upstream's
 * defaults are sized for desktop: the command list alone is 256 KiB. This
...
#define MU_IDSTACK_SIZE         8           /* upstream: 32 */
#define MU_LAYOUTSTACK_SIZE     8           /* upstream: 16 */
#define MU_CONTAINERPOOL_SIZE   8           /* upstream: 48 */
#define MU_TREENODEPOOL_SIZE    8           /* upstream: 48 */
