...
static inline int
ui_slider_knob_w(mu_Rect track, int knob_w) {
    return mu_clamp(knob_w, 0, mu_max(track.w, 0));
}

static inline int
ui_slider_travel(mu_Rect track, int knob_w) {
...
static inline int
ui_slider_knob_center_x(mu_Rect track, int lo, int hi, int value, int knob_w) {
