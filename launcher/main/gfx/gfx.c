...
#if GFX_QSPI_STRONG_PADS
    /* AFTER spi_bus_initialize(), which is what configures these pads - set
     * before it and the driver overwrites the setting. See GFX_QSPI_STRONG_PADS
     * (gfx.h) for why edge rate is the suspect at 80 MHz. */
    {
        ...
        ESP_LOGI(TAG, "QSPI %d MHz, pads at 40 mA",
                 (int)(GFX_QSPI_HZ / 1000000));
    }
#endif
