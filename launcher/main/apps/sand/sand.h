 ...
 * move or replace a cell). No-op if disabled, off-grid, already empty,
 * the buffer is full, or the cell is KIND_STATIC - a wall is never thrown
 * through this function; sand_explode() and sand_impulse_dislodge()
