...
#define ALL_PAIRS_SPAWN_COUNT    (ALL_PAIRS_ORDINARY_COUNT + ALL_PAIRS_EXTENDED_COUNT + 1 /* gunpowder */)
...
_Static_assert(ALL_PAIRS_SPAWN_COUNT == 19, "the tiling's slot count must stay PRIME or full pair "
