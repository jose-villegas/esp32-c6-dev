...
typedef enum {
    F_flammability, F_needs_air,
    F_burns, F_burn_decay, F_residue, F_flare, F_explodes,
    F_dissolves, F_dissolvable, F_fizz, F_evaporates,
    F_condenses,
    F_heat_chance, F_melts, F_flaw_chance, F_spoils_chance,
    F_heat_ramp, F_cools,
