...
test_full_state_formats_exactly(void) {
    ...
    const char* expected = "{\"uptime_us\":1234567,\"heap_free_bytes\":200000,"
...
static void
test_imu_not_ready_omits_axes(void) {
...
static void
test_imu_ready_but_read_failed(void) {
    device_state_t state = {0};
